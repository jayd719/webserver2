...
function menu() {
  return `
    <ul class="flex flex-col md:flex-row gap-2 font-bold" id="menu">
        <li class="py-2 px-3 rounded-2xl group flex items-center gap-2 hover:scale-[1.04] hover:cursor-pointer group"><a href="/projects"><p>Projects</p></a>
        ...
        <li class="py-2 px-3 rounded-2xl group flex items-center gap-2 hover:scale-[1.04] hover:cursor-pointer"><a href="/version_1/aboutme/"><p>About Me</p></a>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right group-hover:rotate-[45deg] transition duration-300" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z"/>
            </svg>
        </li>
        <li class="py-2 px-3 rounded-2xl group flex items-center gap-2 hover:scale-[1.04] hover:cursor-pointer"><a onclick="my_modal_2.showModal();"><p>Contact</p></a>  
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right group-hover:rotate-[45deg] transition duration-300" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z"/>
            </svg>
        </li>
