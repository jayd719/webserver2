...
function createHeroSection() {
  ...
  heroContent.className = "container mx-auto px-4 z-10 flex flex-col lg:flex-row items-center justify-between gap-12"
  ...
  profession.className = "text-xl md:text-2xl text-gray-600 typing-text"
  profession.setAttribute("data-text", "Innovative Engineer & Software Developer")
  professionContainer.appendChild(profession)
  textContent.appendChild(professionContainer)

  // Create the bio paragraph
  const paragraph = document.createElement("p")
  paragraph.className = "text-gray-400 mb-8 max-w-lg mx-auto lg:mx-0"
  paragraph.textContent =
    "I specialize in developing cutting-edge solutions that combine software engineering with AI technologies. With expertise in CNC machining and a passion for innovation, I create applications that solve real-world problems."
  ...
  socials.forEach((social) => {
    ...
    link.className =
      "w-10 h-10 rounded-full border border-gray-600 flex items-center justify-center text-gray-400 transition-all duration-300 hover:border-primary hover:text-primary hover:scale-110"
  ...
  profileImage.src = "https://via.placeholder.com/400"
  ...
  scrollIndicator.className =
    "absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-gray-400 animate-bounce"
